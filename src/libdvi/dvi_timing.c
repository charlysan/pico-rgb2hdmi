...
// VGA at a ~2.4% faster bit clock (61.4Hz frame, slightly out of spec)
const struct dvi_timing __dvi_const(dvi_timing_640x480p_61hz) = {
	.h_sync_polarity   = false,
	.h_front_porch     = 16,
	.h_sync_width      = 96,
	.h_back_porch      = 48,
...
// Output solid black scanline if we are given NULL for tmdsbuff
static uint32_t __dvi_const(black_scanline_tmds_2_symbols)[3] = {
	0x7fd00u, // 0x00, 0x00
	0x7fd00u, // 0x00, 0x00
	0x7fd00u, // 0x00, 0x00
};

static uint32_t __attribute__((aligned(8))) __dvi_const(black_scanline_tmds_1_symbol)[6] = {
